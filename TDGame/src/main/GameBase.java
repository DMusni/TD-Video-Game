 ...
 * Most of this code is taken from class example 
 */

public class GameBase extends JFrame implements KeyListener, MouseListener, MouseMotionListener {

	
	int mx = -1; //mouse coordinates
	int my = -1;

	//boolean array for keyboard presses
